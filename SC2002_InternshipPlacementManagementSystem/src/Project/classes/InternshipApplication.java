...
public class InternshipApplication  {
    ...
    private boolean withdrawAccepted;
    ...
    public InternshipApplication(String id, Student student, Internship internship, String status, boolean accepted, boolean withdrawalRequested) {
        ...
        this.withdrawAccepted = false;    // 新增：默认未同意撤回
    ...
    public InternshipApplication(String id, Student student, Internship internship, String status, boolean accepted, boolean withdrawalRequested, boolean withdrawAccepted) {
        this.id = id;
        this.student = student;
        this.internship = internship;
        this.accepted = accepted;
        this.status = status;
        this.withdrawalRequested = withdrawalRequested;
        this.withdrawAccepted = withdrawAccepted;
    ...
    public void setWithdrawAccepted(boolean withdrawAccepted) {
        this.withdrawAccepted = withdrawAccepted;
    }


    public boolean isWithdrawAccepted() {
        return this.withdrawAccepted;
    }
    ...
    public String toString() {
        ...
        sb.append("Internship Application Details:\n");
        sb.append("ID: ").append(id).append("\n");
        sb.append("Student: ").append(student.getName())
                .append(" (").append(student.getId()).append(")\n");
        sb.append("Internship: ").append(internship.getTitle())
                .append(" (").append(internship.getId()).append(")\n");
        sb.append("Status: ").append(status).append("\n");
        sb.append("Accepted: ").append(accepted ? "Yes" : "No").append("\n");
        sb.append("Withdrawal Requested: ").append(withdrawalRequested ? "Yes" : "No").append("\n");
        sb.append("Withdraw Accepted: ").append(withdrawAccepted ? "Yes" : "No");  // 新增
